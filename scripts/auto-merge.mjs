 ...
 *
 * Usage:
 *   node scripts/auto-merge.mjs                    # dry run (show what would merge)
 *   node scripts/auto-merge.mjs --live             # execute auto-merges
 *   node scripts/auto-merge.mjs --wecom            # notify WeCom
 *   node scripts/auto-merge.mjs --live --wecom      # merge + notify
 *
 * Environment:
