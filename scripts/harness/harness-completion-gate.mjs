 ...
 *
 * Usage:
 *   node scripts/harness/harness-completion-gate.mjs
 *   node scripts/harness/harness-completion-gate.mjs --json
 *   node scripts/harness/harness-completion-gate.mjs --fail-on-concern
 *
 * Exit codes:
 *   0 = all pillars pass
