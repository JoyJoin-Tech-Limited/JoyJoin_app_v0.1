 ...
 *
 * Usage:
 *   node scripts/devtools/screenshot-mini-program-page.mjs <page-path>
 *
 * Examples:
 *   node scripts/devtools/screenshot-mini-program-page.mjs pages/discover/index
 *   node scripts/devtools/screenshot-mini-program-page.mjs pages/profile/index
 */
