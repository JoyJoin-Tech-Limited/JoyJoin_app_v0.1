 ...
 *
 * Usage:
 *   node scripts/run-sprint-evaluation.mjs --contract=<path> [--base-url=http://localhost:5000]
 *
...
function main() {
  ...
  if (!contractPath || !existsSync(contractPath)) {
    console.error("Usage: node scripts/run-sprint-evaluation.mjs --contract=<path> [--base-url=http://localhost:5000]");
    process.exit(1);
  }
