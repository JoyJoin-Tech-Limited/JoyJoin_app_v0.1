...
const ownership = [
  ...
  ['apps/admin-client/package.json', 'dependencies', ['@radix-ui/react-progress', '@radix-ui/react-radio-group', '@radix-ui/react-scroll-area', '@radix-ui/react-slider', '@tailwindcss/typography', 'tailwindcss-animate']],
  ['apps/admin-client/package.json', 'devDependencies', ['@types/node', 'vitest']],
];
