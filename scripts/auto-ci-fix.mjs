 ...
 *
 * Usage:
 *   node scripts/auto-ci-fix.mjs --run-id 12345678        # investigate specific run
 *   node scripts/auto-ci-fix.mjs --commit abc1234          # investigate commit
 *   node scripts/auto-ci-fix.mjs --dry-run                 # preview only
 *
 * Environment:
