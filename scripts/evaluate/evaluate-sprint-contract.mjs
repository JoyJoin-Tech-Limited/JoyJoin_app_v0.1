 ...
 *
 * Usage:
 *   node scripts/evaluate/evaluate-sprint-contract.mjs --contract=<path> [--diff=<baseRef>]
 *
...
function main() {
  ...
  if (!contractPath || !existsSync(contractPath)) {
    console.error("Usage: node scripts/evaluate/evaluate-sprint-contract.mjs --contract=<path> [--diff=<baseRef>]");
    process.exit(1);
  }
