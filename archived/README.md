...
- **`docs/`** - Historical documentation including:
  - Implementation summaries and reports
  - Refactoring documentation
  - Bug fix summaries and changelogs
  - Testing reports and guides
  - Visual guides and mockups
  - Architecture and design documents
  
- **`images/`** - Screenshot assets and visual references including:
  - UI screenshots from various implementation phases
  - Before/after comparison images
  - Testing and verification screenshots
...
For current, active documentation, please refer to the files at the repository root:
