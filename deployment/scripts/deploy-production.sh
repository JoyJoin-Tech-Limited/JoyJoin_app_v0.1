...
upsert_if_nonempty "WECHAT_SUBSCRIBE_TMPL_MATCH_SUCCESS" "$WECHAT_SUBSCRIBE_TMPL_MATCH_SUCCESS"
upsert_if_nonempty "WECHAT_SUBSCRIBE_TMPL_EVENT_REMINDER" "$WECHAT_SUBSCRIBE_TMPL_EVENT_REMINDER"
upsert_if_nonempty "WECHAT_SUBSCRIBE_TMPL_RECAP" "$WECHAT_SUBSCRIBE_TMPL_RECAP"
