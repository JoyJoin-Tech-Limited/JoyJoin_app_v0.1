      ...
      evidence: [
        ...
        },
        {
          ...
          evidenceReactions: {
            ...
            '2': '伯爵夫人轻轻嗅了嗅：「是今早新摘的，露水味还在呢。」说罢瞥了一眼客厅角落。',
      ...
      evidence: [
        {
          ...
          evidenceReactions: {
            ...
            '4': '说书人拿起铜板掂了掂：「成色不错……咦，我怎么觉得这仨铜板有点儿眼熟？」',
          },
        },
        {
          id: 'e2',
          ...
          evidenceReactions: {
            ...
            '4': '说书人眯眼端详半晌：「好字！这笔锋，倒像是说书先生写招牌练出来的功夫。」',
          },
        },
      ],
    },
      ...
      evidence: [
        {
          ...
          iconKey: '糕点',
          evidenceReactions: {
            '1': '小师弟跳起来：「这是我掰的没错，可这是另一块的边角！少的那个角真不是我！」',
            '2': '大师姐端详片刻点点头：「掰边角的人嘴馋归嘴馋，倒还知道规矩，没碰整块的。」',
            '3': '厨娘凑近看了看：「切口整整齐齐，是用手掰的——我们膳房的刀可不背这锅。」',
            '4': '说书人咽了口唾沫：「桂花糕啊……说起来，我家乡的团圆饼，也是这个味道。」',
          },
        },
      ],
    },
