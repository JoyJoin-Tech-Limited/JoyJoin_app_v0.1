import { DEFAULT_MASCOT_DISPLAY_NAME } from '../../mascotConfig'
import type { EventThemeVibe, PoolGroupSummary, PoolRegistrationSummary } from '../../api'
import type { OverallChemistry, PairExplanation } from '../../types/groupAnalysis'
import type { EventThemeTitleRevealedData } from '../../wsEvents'
...
// ─── Time constants (inlined from former uiConstants dependency) ───
