...
export const questionsV4L2: AdaptiveQuestion[] = [
    ...
    options: [
      {
        ...
        traitScores: { A: 4, C: -1, E: 0, O: 0, X: -1, P: 0 }
      },
      {
        value: "B",
        text: "等ta情绪平稳后，帮ta把问题分解，列出可能的解决步骤",
        traitScores: { A: -1, C: 4, E: 3, O: 0, X: -1, P: 0 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: -3, C: -1, E: -1, O: 0, X: -1, P: -3 }
      },
      {
        value: "E",
        text: "提议做些别的事情分散注意力",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -2, E: -1, O: 0, X: 4, P: 2 }
      },
      {
        value: "B",
        text: "沉迷于研究它的历史、店主故事或设计理念",
        traitScores: { A: -1, C: 1, E: -1, O: 2, X: -1, P: -1 }
      },
      {
        value: "C",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -2, E: -2, O: 0, X: 4, P: 2 }
      },
      {
        value: "C",
    ...
    options: [
      {
        value: "A",
        text: "直接给出准确答案和详细信息",
        traitScores: { A: 0, C: 2, E: -1, O: 0, X: 2, P: -1 }
      },
      {
        value: "B",
        text: "先鼓励ta，然后@可能更了解的人一起来帮忙",
        traitScores: { A: 1, C: -1, E: -1, O: 0, X: 0, P: 3 }
      },
      {
        value: "C",
        text: "私聊告诉提问者，避免刷屏",
      ...
      },
      {
        ...
        traitScores: { A: -2, C: -1, E: 2, O: 0, X: -1, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 1, C: -1, E: 3, O: 0, X: -1, P: 0 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: -4, C: 1, E: -1, O: 0, X: 0, P: -2 }
      },
      {
        value: "E",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 0, E: -1, O: 4, X: 0, P: 0 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "D",
        text: "不提这个规则，继续正常玩",
        traitScores: { A: -1, C: -1, E: 2, O: -2, X: 0, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "自己闷声发大财，先抢到再说。",
        traitScores: { A: -3, C: 0, E: -1, O: 1, X: 0, P: -2 }
      },
      {
        value: "B",
        text: "在群里大方分享技巧，带着大家一起抢。",
        traitScores: { A: 4, C: -1, E: -1, O: 1, X: 2, P: 2 }
      },
      {
        value: "C",
        text: "觉得麻烦，不想为了这点利去钻研技巧。",
        traitScores: { A: -1, C: -1, E: 2, O: -1, X: -1, P: 0 }
      },
      {
        value: "D",
        text: "担心破坏规则，选择不使用这个技巧。",
        traitScores: { A: 0, C: 2, E: 0, O: -1, X: -1, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "我觉得...不太是我的菜",
        traitScores: { A: -2, C: 0, E: -1, O: 2, X: 1, P: -1 }
      },
      {
        value: "B",
        text: "还不错，画面挺好看的！",
        traitScores: { A: 1, C: 0, E: 0, O: -1, X: 0, P: 2 }
      },
      {
        value: "C",
        text: "哈哈你真的很喜欢这类型的对吧？",
        traitScores: { A: 1, C: 0, E: -1, O: 0, X: 0, P: -1 }
      },
      {
        value: "D",
        text: "含糊带过，期待话题自然转移",
    ...
    options: [
      {
        ...
        traitScores: { A: -2, C: 0, E: -1, O: 3, X: 1, P: -1 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 0, E: 2, O: -2, X: -2, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 2, C: -1, E: -1, O: -1, X: 1, P: 2 }
      },
      {
        value: "B",
        text: "用账单小程序计算，确保每人分摊完全公平。",
        traitScores: { A: -2, C: 3, E: -1, O: 0, X: -1, P: -1 }
      },
      {
        value: "C",
        text: "大概分一下就行，不用算那么细。",
        traitScores: { A: 1, C: -3, E: 1, O: 2, X: 0, P: 0 }
      },
      {
        value: "D",
        text: "先让大家记账，最后总金额算清楚。",
        traitScores: { A: -1, C: 1, E: 1, O: -1, X: 0, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "问群里有没有人去过或有推荐",
        traitScores: { A: 2, C: -1, E: -1, O: -1, X: 2, P: 0 }
      },
      {
        value: "B",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -1, C: -1, E: 3, O: -1, X: -1, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        value: "B",
        text: "我是组织协调者/资源连接者",
        traitScores: { A: 3, C: 1, E: 0, O: -1, X: 0, P: 0 }
      },
      {
        value: "C",
        text: "我是深度参与者/知识提供者",
        traitScores: { A: -1, C: 1, E: 0, O: 4, X: 0, P: 0 }
      },
      {
        value: "D",
        text: "我是边缘观察者/偶尔露面的人",
        traitScores: { A: -2, C: -2, E: 0, O: -2, X: -2, P: -2 }
      },
      {
        value: "E",
        text: "我是稳定参与者/支持性成员",
        traitScores: { A: 1, C: 0, E: 0, O: -1, X: -1, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -3, E: 0, O: 1, X: 2, P: 0 }
      },
      {
        value: "B",
        text: "几个经过初步推敲、可行性较高的方案",
        traitScores: { A: 0, C: 3, E: 0, O: -2, X: 0, P: 0 }
      },
      {
        value: "C",
        text: "一个深入、系统但可能略显复杂的框架性想法",
        traitScores: { A: -1, C: 0, E: 0, O: 3, X: -2, P: 0 }
      },
      {
        value: "D",
        text: "在别人想法的基础上进行补充和优化",
        traitScores: { A: 1, C: 0, E: 0, O: -2, X: 0, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -1, E: -3, O: 0, X: -2, P: 0 }
      },
      {
        value: "B",
        text: "无所谓，大家可能都在忙，等下自然会有人回",
        traitScores: { A: 0, C: -1, E: 3, O: 0, X: 0, P: 0 }
      },
      {
        value: "C",
        text: "主动@某个可能感兴趣的人，或发个表情包救场",
        traitScores: { A: 0, C: -1, E: 0, O: 0, X: 2, P: 0 }
      },
      {
        value: "D",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 0, E: -2, O: 0, X: 3, P: 1 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 0, E: 0, O: 0, X: -3, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 4, E: -1, O: 0, X: 0, P: -1 }
      },
      {
        value: "B",
        text: "以鼓励为主，提一点建议时会特别注意措辞",
        traitScores: { A: 2, C: -1, E: -1, O: 0, X: 0, P: 3 }
      },
      {
        value: "C",
        text: "简单勾选评分，简短评论",
      ...
      },
      {
        ...
        traitScores: { A: -1, C: -2, E: 1, O: 0, X: 0, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "积极推销自己最感兴趣的风格",
        traitScores: { A: -2, C: -1, E: -1, O: 2, X: 4, P: 0 }
      },
      {
        value: "B",
        text: "倾听各方偏好，尝试找折中方案",
        traitScores: { A: 4, C: 0, E: 0, O: -1, X: -1, P: 0 }
      },
      {
        value: "C",
      ...
      },
      {
        value: "D",
        text: "我都可以，大家决定好了告诉我",
        traitScores: { A: -1, C: -1, E: 2, O: -1, X: -2, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "大冒险！越刺激有趣越好",
        traitScores: { A: -1, C: -2, E: -2, O: 0, X: 3, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 1, E: 2, O: 0, X: -2, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 1, E: 0, O: 0, X: 0, P: -1 }
      },
      {
        value: "C",
        text: "理直气壮地回一句你也撞到我了，维护自己的边界",
        traitScores: { A: -3, C: -1, E: -3, O: 0, X: 2, P: -2 }
      },
      {
        value: "D",
        text: "心平气和地说一句不好意思，并观察对方是否需要帮助",
        traitScores: { A: 3, C: 1, E: 1, O: 0, X: 0, P: 3 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 1, C: -1, E: -1, O: 1, X: 3, P: 0 }
      },
      {
        value: "B",
        text: "自己先看完并总结出几个核心点，连同链接一起发给ta",
        traitScores: { A: 3, C: 2, E: -1, O: 2, X: 0, P: 1 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: -3, C: -1, E: 0, O: -2, X: 0, P: -3 }
      },
      {
        value: "E",
        text: "觉得可能打扰到对方，或者对方自己也能看到，就不发了",
        traitScores: { A: -1, C: 0, E: 2, O: -1, X: -2, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -1, E: -4, O: -2, X: 0, P: -3 }
      },
      {
        value: "B",
        text: "虽然遗憾，但很快开始寻找室内的好玩项目",
        traitScores: { A: 0, C: 1, E: 1, O: 3, X: 2, P: 1 }
      },
      {
        value: "C",
        text: "觉得室内聚会也挺好，可以更安静地聊天，也不错",
        traitScores: { A: 2, C: -1, E: 3, O: 0, X: 0, P: 2 }
      },
      {
        value: "D",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 2, C: -1, E: -1, O: 0, X: 2, P: 0 }
      },
      {
        value: "D",
        text: "不太感兴趣，我还是喜欢做自己熟悉的事",
        traitScores: { A: -1, C: 0, E: 2, O: -2, X: -1, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -1, E: 0, O: 0, X: 3, P: 0 }
      },
      {
        value: "D",
      ...
      },
      {
        ...
        traitScores: { A: 1, C: -1, E: 0, O: 0, X: -1, P: 4 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 0, E: -3, O: 0, X: 3, P: 3 }
      },
      {
        value: "B",
        text: "有点累，需要去安静角落或室外透透气",
        traitScores: { A: -1, C: 0, E: 1, O: 0, X: -1, P: -1 }
      },
      {
        value: "C",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -2, C: 0, E: 1, O: 0, X: -2, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 0, E: -1, O: 3, X: 2, P: 0 }
      },
      {
        value: "B",
        text: "先问朋友你觉得怎么样？，根据对方的反应再展开",
        traitScores: { A: 3, C: 0, E: 0, O: -1, X: 0, P: 0 }
      },
      {
        value: "C",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 1, C: 3, E: -1, O: 0, X: -1, P: -2 }
      },
      {
        value: "C",
        text: "顺其自然，如果他们没话聊，也不用强求",
        traitScores: { A: -2, C: -1, E: 3, O: 0, X: -2, P: 0 }
      },
      {
        value: "D",
        text: "开个玩笑缓和气氛，或者提议去做点别的事情",
        traitScores: { A: -1, C: -2, E: -1, O: 0, X: 3, P: 2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: -2, O: 0, X: 3, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -1, C: -1, E: 3, O: 0, X: -2, P: -1 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -1, E: 1, O: 0, X: 2, P: 0 }
      },
      {
        value: "B",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 0, E: -1, O: 4, X: -1, P: 0 }
      },
      {
        value: "C",
        text: "和旁边的人交流想法，可能会合作或互相模仿",
        traitScores: { A: 3, C: -1, E: -1, O: -1, X: 2, P: 0 }
      },
      {
        value: "D",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -1, E: 3, O: -1, X: 0, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -1, E: -2, O: 0, X: 3, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "C",
        text: "点个赞，或者简单评论恭喜！",
        traitScores: { A: -2, C: 0, E: 3, O: 0, X: 0, P: -1 }
      },
      {
        value: "D",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 2, E: 0, O: 2, X: -2, P: 0 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 0, E: 2, O: -3, X: 0, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -2, E: -2, O: 3, X: 3, P: 1 }
      },
      {
        value: "B",
        text: "先绕场一周了解全貌，再有选择地重点逛",
        traitScores: { A: -1, C: 4, E: 0, O: -1, X: -1, P: -1 }
      },
      {
        value: "C",
...

  {
    ...
    options: [
      ...
      { value: "D", text: "完全不想去，和一群陌生人社交很消耗能量", traitScores: { A: 0, C: 0, E: 0, O: 0, X: -3, P: 0 } }
    ]
  },
  {
    id: "Q52_PureO",
    ...
    options: [
      ...
      { value: "D", text: "对冷门历史完全没兴趣，还不如看部热门电影", traitScores: { A: 0, C: 0, E: 0, O: -3, X: 0, P: 0 } }
    ]
  },
  {
    id: "Q53_PureC",
    ...
    options: [
      ...
      { value: "D", text: "经常忘记 deadline，需要别人提醒才能交", traitScores: { A: 0, C: -3, E: 0, O: 0, X: 0, P: 0 } }
    ]
  },
  {
    id: "Q54_PureP",
    ...
    options: [
      ...
      { value: "D", text: "非常烦躁，整个周末的心情都被毁了", traitScores: { A: 0, C: 0, E: 0, O: 0, X: 0, P: -3 } }
    ]
  },
];
