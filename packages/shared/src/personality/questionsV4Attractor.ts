    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -1, E: 0, O: 3, X: -4, P: -2 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "C",
        text: "能不能认识新朋友、扩大社交圈",
        traitScores: { A: 0, C: -1, E: 0, O: -1, X: 3, P: 1 }
      },
      {
        value: "D",
        text: "这件事是否值得我投入时间和精力",
        traitScores: { A: 0, C: 3, E: 0, O: -1, X: -2, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "听到让我眼前一亮的观点或角度",
        traitScores: { A: -1, C: 0, E: 0, O: 3, X: -4, P: -2 }
      },
      {
        value: "B",
        text: "大家笑成一团、气氛嗨到极点",
        traitScores: { A: -1, C: 0, E: 0, O: -2, X: 3, P: 2 }
      },
      {
        value: "C",
        text: "巧妙地化解分歧，让讨论更有建设性",
        traitScores: { A: 0, C: 0, E: 0, O: 1, X: -1, P: -1 }
      },
      {
        value: "D",
        text: "交到几个聊得来的新朋友",
        traitScores: { A: 2, C: 0, E: 0, O: -2, X: 2, P: 1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 0, O: 4, X: -4, P: -2 }
      },
      {
        value: "B",
        text: "约几个好友出来聚聚、聊聊天",
        traitScores: { A: 0, C: 0, E: 0, O: -3, X: 4, P: 3 }
      },
      {
        value: "C",
        text: "在社交媒体上互动、看看朋友们在干嘛",
        traitScores: { A: 0, C: 0, E: 0, O: -2, X: 2, P: 0 }
      },
      {
        value: "D",
        text: "看部好电影或读本好书，享受独处",
        traitScores: { A: 0, C: 0, E: 0, O: 1, X: -2, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: -1, O: 3, X: -3, P: -2 }
      },
      {
        value: "B",
        text: "找大家一起头脑风暴，集思广益",
        traitScores: { A: 0, C: -1, E: -1, O: -1, X: 4, P: 2 }
      },
      {
        value: "C",
        text: "按部就班，用已验证的方法一步步解决",
        traitScores: { A: 0, C: 3, E: 0, O: -3, X: 0, P: 0 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 0, E: -1, O: -1, X: 5, P: 2 }
      },
      {
        value: "B",
        text: "和亲近的朋友深度聊天，互相鼓励打气",
        traitScores: { A: 3, C: 0, E: 3, O: -1, X: -1, P: 0 }
      },
      {
        value: "C",
        text: "做点让自己开心的事，比如吃顿好的、看个喜剧",
        traitScores: { A: -1, C: 0, E: -1, O: 1, X: -1, P: 0 }
      },
      {
        value: "D",
        text: "好好睡一觉，安静地休息恢复",
        traitScores: { A: -1, C: 0, E: -1, O: 1, X: -3, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 4, O: -2, X: -1, P: 2 }
      },
      {
        value: "B",
        text: "和每个人都聊得开心、让大家都舒服",
        traitScores: { A: 2, C: 0, E: -1, O: -2, X: 3, P: 0 }
      },
      {
        value: "C",
        text: "找到几个特别聊得来的人深入交流",
        traitScores: { A: 0, C: 0, E: -2, O: 1, X: 1, P: -1 }
      },
      {
        value: "D",
        text: "观察大家的互动，感受社交的有趣之处",
        traitScores: { A: -2, C: 0, E: -1, O: 3, X: -3, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -2, C: -1, E: 0, O: 0, X: 4, P: -2 }
      },
      {
        value: "C",
        text: "分享到朋友圈帮ta宣传，让更多人知道",
        traitScores: { A: 0, C: -1, E: 0, O: 0, X: 0, P: 1 }
      },
      {
        value: "D",
        text: "默默记在心里，下次有机会帮ta一把",
        traitScores: { A: 0, C: 2, E: 0, O: 0, X: -2, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 3, C: 0, E: 0, O: -2, X: -3, P: 2 }
      },
      {
        value: "B",
        text: "怎么让气氛更活跃、让大家玩得更开心",
        traitScores: { A: -2, C: -2, E: 0, O: 0, X: 4, P: 1 }
      },
      {
        value: "C",
        text: "谁比较有趣、值得深入认识",
        traitScores: { A: -1, C: 0, E: 0, O: 1, X: 0, P: -1 }
      },
      {
        value: "D",
        text: "整体的群体动态和人际关系结构",
        traitScores: { A: 0, C: 2, E: 0, O: 1, X: -1, P: -2 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: 2, C: 0, E: 0, O: -1, X: -3, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "C",
        text: "交到了新朋友，扩展了社交圈子",
        traitScores: { A: 0, C: 0, E: 0, O: 0, X: 1, P: 0 }
      },
      {
        value: "D",
        text: "进行了有深度的对话，收获了新的想法",
        traitScores: { A: -1, C: 0, E: 0, O: 2, X: -2, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 3, C: -1, E: -1, O: -2, X: -2, P: 3 }
      },
      {
        value: "B",
        text: "带ta去做些好玩的事，用快乐转移注意力",
        traitScores: { A: -1, C: -1, E: -1, O: 0, X: 4, P: -2 }
      },
      {
        value: "C",
        text: "帮ta分析问题，一起想解决方案",
        traitScores: { A: -3, C: 3, E: -1, O: 2, X: 0, P: -1 }
      },
      {
        value: "D",
        text: "默默陪伴，让ta知道我一直在",
    ...
    options: [
      {
        ...
        traitScores: { A: -2, C: -1, E: 3, O: 0, X: 4, P: -2 }
      },
      {
        value: "B",
        text: "关注每个人的状态，确保没人被冷落",
        traitScores: { A: 4, C: -1, E: -3, O: 0, X: -1, P: 3 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: -2, C: 1, E: 1, O: 0, X: -3, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -3, C: -2, E: 3, O: -1, X: 4, P: 2 }
      },
      {
        value: "B",
        text: "认真倾听，给予温暖的理解和支持",
        traitScores: { A: 4, C: -1, E: 0, O: -1, X: -4, P: 0 }
      },
      {
        value: "C",
        text: "分享自己的经验，提供实用的建议",
        traitScores: { A: -1, C: 4, E: -1, O: 2, X: -1, P: -2 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 0, E: -4, O: 5, X: -1, P: 0 }
      },
      {
        value: "B",
        text: "做些熟悉的放松活动，让自己回到舒适状态",
        traitScores: { A: -1, C: 0, E: 3, O: -3, X: 0, P: 0 }
      },
      {
        value: "C",
        text: "和亲近的朋友聊聊今天的感受",
        traitScores: { A: 3, C: 0, E: 0, O: -1, X: 3, P: 0 }
      },
      {
        value: "D",
        text: "早点休息，充足睡眠最重要",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 1, E: -2, O: 3, X: 0, P: 0 }
      },
      {
        value: "B",
        text: "保持稳定态度，帮助团队专注于核心问题",
        traitScores: { A: -1, C: 1, E: 3, O: -2, X: 0, P: 0 }
      },
      {
        value: "C",
        text: "积极推动讨论，确保每个人的意见被听到",
        traitScores: { A: 3, C: -1, E: -1, O: -1, X: 3, P: 0 }
      },
      {
        value: "D",
        text: "安静倾听，需要时再补充想法",
        traitScores: { A: -1, C: -1, E: 0, O: 0, X: -3, P: 0 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 0, O: 0, X: 4, P: 0 }
      },
      {
        value: "B",
        text: "先自己深入思考完善，再选择性地分享",
        traitScores: { A: 0, C: 0, E: 0, O: 2, X: -3, P: 0 }
      },
      {
        value: "C",
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 0, O: -1, X: 5, P: 0 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "C",
        text: "和身边的人讨论，碰撞出新火花",
        traitScores: { A: 0, C: 0, E: 0, O: -1, X: 1, P: 0 }
      },
      {
        value: "D",
        text: "观察别人的创意，学习不同的思路",
        traitScores: { A: 0, C: 0, E: 0, O: -1, X: -2, P: 0 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 0, O: 0, X: 5, P: 3 }
      },
      {
        value: "B",
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -1, E: 0, O: 0, X: 4, P: 5 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "C",
        text: "心平气和地等着，反正急也没用",
        traitScores: { A: 0, C: -1, E: 3, O: 0, X: -3, P: -3 }
      },
      {
        value: "D",
        text: "主动问一下进度，看看能不能加快",
        traitScores: { A: 0, C: 2, E: -2, O: 0, X: 0, P: -2 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: 4, C: 0, E: -2, O: 0, X: 4, P: 1 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -4, C: 0, E: 1, O: 0, X: -1, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 3, C: 0, E: 0, O: 0, X: 3, P: 2 }
      },
      {
        value: "B",
        text: "真心为ta高兴，表达诚挚的祝福",
        traitScores: { A: 1, C: 0, E: 0, O: 0, X: 0, P: 0 }
      },
      {
        value: "C",
        text: "替ta开心，问问接下来的计划",
        traitScores: { A: -1, C: 0, E: 0, O: 0, X: 0, P: -1 }
      },
      {
        value: "D",
        text: "说声恭喜，内心替ta感到高兴",
        traitScores: { A: -3, C: 0, E: 0, O: 0, X: -3, P: -1 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: 5, C: -2, E: -2, O: 0, X: 3, P: 3 }
      },
      {
        value: "B",
        text: "认真倾听，偶尔点头，让ta知道你在，不急着给建议",
        traitScores: { A: 0, C: 0, E: 3, O: 0, X: -1, P: -1 }
      },
      {
        value: "C",
        text: "帮ta分析问题，提供一些实际的解决思路",
        traitScores: { A: -2, C: 3, E: -1, O: 0, X: 0, P: -1 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: 4, C: -1, E: 0, O: -2, X: -3, P: 1 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "C",
        text: "活动流程顺畅，时间安排合理",
        traitScores: { A: -3, C: 3, E: 0, O: -1, X: 0, P: -2 }
      },
      {
        value: "D",
        text: "惊喜环节够特别，让寿星印象深刻",
        traitScores: { A: -1, C: -1, E: -2, O: 4, X: 1, P: 1 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -2, E: 0, O: -2, X: 4, P: 5 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: 2, C: 1, E: 0, O: 0, X: -3, P: 0 }
      },
      {
        value: "D",
        text: "分析问题出在哪里，提出调整方案",
        traitScores: { A: -1, C: 1, E: -1, O: 2, X: 0, P: -3 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 0, O: -1, X: 3, P: 5 }
      },
      {
        value: "B",
        text: "心态平稳，不太有大起大落，该做什么做什么",
        traitScores: { A: 0, C: 1, E: 2, O: -1, X: -1, P: -3 }
      },
      {
        value: "C",
        text: "需要找点有意思的事做，不然会有点无聊",
        traitScores: { A: 0, C: -1, E: -2, O: 3, X: 1, P: -1 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: -2, C: -2, E: 0, O: 4, X: 1, P: 1 }
      },
      {
        value: "B",
        text: "吃瓜看评论，觉得很有意思，偶尔点个赞互动",
        traitScores: { A: 0, C: 0, E: 1, O: 0, X: 5, P: 2 }
      },
      {
        value: "C",
      ...
      },
      {
        value: "D",
        text: "有些厌烦这种争论，默默划走",
        traitScores: { A: -1, C: 1, E: -2, O: -3, X: -5, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 0, E: -2, O: -1, X: 4, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 0, E: 1, O: 2, X: -1, P: -1 }
      },
      {
        value: "D",
        text: "不太想去，除非有认识的人陪同",
        traitScores: { A: 2, C: 0, E: 1, O: -2, X: -4, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -3, C: 0, E: 0, O: 0, X: -4, P: -1 }
      },
      {
        value: "B",
        text: "会想找朋友线上聊聊天，分享一下今天的事",
        traitScores: { A: 1, C: -1, E: 0, O: 0, X: 3, P: 1 }
      },
      {
        value: "C",
        text: "独处很舒服，但如果朋友需要我，我随时愿意陪伴",
        traitScores: { A: 4, C: -1, E: 0, O: 0, X: 0, P: -1 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: -2, C: -2, E: 3, O: -2, X: 4, P: 3 }
      },
      {
        value: "B",
        text: "静静听完，给一个拥抱或者陪着ta",
        traitScores: { A: 5, C: -1, E: 0, O: -1, X: -4, P: 1 }
      },
      {
        value: "C",
        text: "帮ta分析问题，提出解决方案",
        traitScores: { A: -2, C: 4, E: 0, O: 2, X: -2, P: -2 }
      },
      {
        value: "D",
        text: "说几句安慰的话，然后岔开话题聊点开心的",
        traitScores: { A: -1, C: -1, E: -3, O: 1, X: 2, P: -2 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: -2, C: -2, E: 0, O: 0, X: 5, P: 5 }
      },
      {
        value: "B",
        text: "保持冷静，分析问题，给出实际可行的建议",
        traitScores: { A: -1, C: 2, E: 0, O: 0, X: -1, P: -3 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: 3, C: -2, E: 0, O: 0, X: -2, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -2, C: -1, E: 0, O: 4, X: 2, P: 0 }
      },
      {
        value: "B",
        text: "参考以前成功的聚会形式，做个靠谱的经典聚餐或K歌",
        traitScores: { A: -1, C: 3, E: 0, O: -3, X: -2, P: -1 }
      },
      {
        value: "C",
        text: "随便聊聊天就行，大家开心最重要，不用太复杂",
        traitScores: { A: 0, C: -3, E: 0, O: -1, X: 2, P: 2 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: 2, C: -1, E: -1, O: 1, X: 4, P: 1 }
      },
      {
        value: "B",
        text: "独自思考，沉浸在自己的想象世界里",
        traitScores: { A: -2, C: 0, E: 1, O: 4, X: -4, P: -1 }
      },
      {
        value: "C",
        text: "参考已有的成功案例，在此基础上优化",
        traitScores: { A: 0, C: 3, E: 1, O: -4, X: -1, P: -1 }
      },
      {
        value: "D",
        text: "边做边想，在实践中调整",
        traitScores: { A: 0, C: -2, E: -1, O: -1, X: 1, P: 1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 4, E: 1, O: -2, X: -3, P: -3 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "D",
        text: "随缘吧，走到哪算哪，轻松就好",
        traitScores: { A: -2, C: -4, E: -1, O: 3, X: 0, P: 3 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -2, E: -2, O: -2, X: 4, P: 4 }
      },
      {
        value: "B",
        text: "给一个温暖的拥抱，真诚地说\"我为你感到开心\"",
        traitScores: { A: 4, C: 0, E: 0, O: -1, X: -2, P: 0 }
      },
      {
        value: "C",
        text: "微笑点头，说\"恭喜\"，保持礼貌距离",
        traitScores: { A: -3, C: 1, E: 1, O: 0, X: -2, P: -2 }
      },
      {
        value: "D",
        text: "\"意料之中，你一直都很优秀\"，冷静肯定",
        traitScores: { A: -1, C: 1, E: 1, O: 3, X: 0, P: -2 }
      }
    ]
  },
    ...
    options: [
      {
        value: "popcorn",
        text: "吃瓜围观",
        traitScores: { A: -3, C: -1, O: 0 },
        iconAssetKey: "popcorn",
      },
      {
        value: "dm",
        text: "私聊关心",
        traitScores: { A: 3, C: -1, X: -1 },
        iconAssetKey: "dm",
      },
      {
        value: "leave",
        text: "暂退群聊",
        traitScores: { A: -1, C: -1, E: 0, X: -3 },
        iconAssetKey: "leave",
      },
      {
        value: "dove",
        text: "转移话题",
        traitScores: { A: 1, C: 0, P: 0 },
        iconAssetKey: "dove",
      },
      {
        value: "direct",
        text: "直接调解",
        traitScores: { A: 0, C: 3, X: 4 },
        iconAssetKey: "direct",
      },
    ],
  },
