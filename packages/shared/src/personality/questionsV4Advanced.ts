    ...
    options: [
      {
        value: "A",
        text: "哇，这个角度好新颖！",
        traitScores: { A: 0, C: -2, E: -1, O: 4, X: 0, P: 0 }
      },
      {
        value: "B",
        text: "有意思，但我想先查证一下。",
      ...
      },
      {
        value: "C",
        text: "这个...我需要时间消化一下。",
        traitScores: { A: 0, C: 0, E: 1, O: -1, X: 0, P: 0 }
      },
      {
        value: "D",
        text: "听起来不太靠谱吧？",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 0, E: 0, O: 4, X: 0, P: 1 }
      },
      {
        value: "B",
        text: "不太懂，但氛围挺特别的",
      ...
      },
      {
        value: "C",
        text: "有点困惑，但陪朋友看看",
        traitScores: { A: 2, C: 0, E: 0, O: -1, X: 0, P: 0 }
      },
      {
        value: "D",
        text: "真的欣赏不来，想早点走",
        traitScores: { A: -1, C: 0, E: 0, O: -3, X: 0, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        value: "C",
        text: "去大众点评上评分最高的地方",
        traitScores: { A: 0, C: 1, E: 0, O: -1, X: 1, P: 0 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: 3, C: -1, E: -1, O: -1, X: 0, P: 0 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -2, C: -1, E: -1, O: 3, X: 0, P: 0 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: -3, O: 0, X: 3, P: 3 }
      },
      {
        value: "B",
        text: "去但早点撤，平衡社交和休息",
        traitScores: { A: 0, C: 2, E: 1, O: 0, X: -1, P: -1 }
      },
      {
        value: "C",
        text: "推掉，我需要时间恢复才能保持好状态",
        traitScores: { A: 0, C: 0, E: 4, O: 0, X: -3, P: -2 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: 3, C: -1, E: 1, O: 0, X: 0, P: -2 }
      },
      {
        value: "B",
        text: "有点烦了，但还是配合表面应付",
      ...
      },
      {
        ...
        traitScores: { A: -2, C: 2, E: -1, O: 0, X: 0, P: 4 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -3, E: -1, O: 4, X: 0, P: 0 }
      },
      {
        value: "C",
    ...
    options: [
      {
        ...
        traitScores: { A: 3, C: 0, E: -1, O: 0, X: 2, P: 0 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -1, C: 0, E: 1, O: 0, X: -4, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 1, O: 0, X: 0, P: 4 }
      },
      {
        value: "B",
        text: "需要一些时间消化这些负面情绪",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -2, E: -2, O: 0, X: 3, P: 2 }
      },
      {
        value: "B",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: 3, E: 1, O: -3, X: 0, P: 0 }
      },
      {
        value: "B",
        text: "趁着灵感还在就直接动手，边做边调整",
        traitScores: { A: -1, C: -2, E: 1, O: 2, X: -1, P: 0 }
      },
      {
        value: "C",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -2, E: -2, O: 0, X: 3, P: 4 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: -2, C: 4, E: 0, O: 0, X: 0, P: -2 }
      },
      {
        value: "D",
        text: "默默陪伴，觉得有时候安静的陪伴比说什么都重要",
        traitScores: { A: 0, C: -1, E: 1, O: 0, X: -2, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 4, C: -2, E: 0, O: -1, X: 1, P: 3 }
      },
      {
        value: "B",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 2, E: 2, O: -2, X: -1, P: 0 }
      },
      {
        value: "C",
        text: "喜欢跳跃式学习，哪里有灵感就学哪里",
        traitScores: { A: 0, C: -3, E: -1, O: 3, X: -1, P: 0 }
      },
      {
        value: "D",
        text: "边学边实践，在应用中加深理解",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 1, E: 2, O: -3, X: -1, P: 0 }
      },
      {
        value: "C",
        text: "思考事物之间的联系，寻找创新的解决思路",
        traitScores: { A: 0, C: -1, E: -3, O: 2, X: -1, P: 0 }
      },
      {
        value: "D",
        text: "淡定面对，相信问题总会有出路",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 3, C: 0, E: -1, O: -2, X: 2, P: 0 }
      },
      {
        value: "C",
        text: "观察形势，找到合适的时机出手",
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -1, E: 0, O: 0, X: 2, P: -1 }
      },
      {
        value: "B",
    ...
    options: [
      {
        value: "A",
        text: "派对！热闹的氛围让我充满活力",
        traitScores: { A: 0, C: -1, E: 0, O: -2, X: 2, P: 2 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "D",
        text: "看看哪边朋友更多再决定",
        traitScores: { A: 0, C: 0, E: 0, O: -1, X: 0, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -2, E: 0, O: 0, X: -3, P: 0 }
      },
      {
        value: "B",
        text: "去但保持低调，观察环境和人群",
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 2, E: -1, O: 0, X: 2, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 3, E: 0, O: 1, X: -1, P: -1 }
      },
      {
        value: "C",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 2, E: 0, O: 0, X: -1, P: 0 }
      },
      {
        value: "C",
        text: "和懂这个话题的人聊聊，从对话中获取灵感",
        traitScores: { A: 0, C: -1, E: -1, O: 0, X: 4, P: 0 }
      },
      {
        value: "D",
        text: "找一本权威书籍，从头到尾认真读完",
        traitScores: { A: 0, C: 2, E: 2, O: -1, X: -2, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -1, E: -3, O: 0, X: 1, P: -1 }
      }
    ]
  },
];
