...
import { questionsV4ExtendedPart2 } from './questionsV4ExtendedPart2';
...
export const questionsV4Extended: AdaptiveQuestion[] = [
  {
    ...
    options: [
      ...
      },
      {
        value: "B",
        text: "看看是谁约、去干嘛，合适就去",
        traitScores: { A: 0, C: 1, E: 0, O: 0, X: 1, P: -1 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: -2, C: 1, E: 2, O: 0, X: -3, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -1, C: -3, E: -1, O: 4, X: 0, P: 1 }
      },
      {
        value: "B",
        text: "结合现实条件的创意，可行性高",
    ...
    options: [
      {
        value: "A",
        text: "单纯觉得有意思，想认识更多人",
        traitScores: { A: -2, C: -1, E: -1, O: 1, X: 3, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: 1, C: 3, E: -1, O: -1, X: 1, P: -1 }
      },
      {
        value: "D",
        text: "说实话我一般不会主动找新认识的人聊",
        traitScores: { A: -2, C: -1, E: 1, O: 0, X: -3, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 4, C: -1, E: -1, O: 0, X: 3, P: 3 }
      },
      {
        value: "B",
        text: "简单安慰几句，约明天再细聊",
      ...
      },
      {
        value: "D",
        text: "看到了但不太想回，假装没看见",
        traitScores: { A: -4, C: -1, E: 0, O: 0, X: -2, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "太棒了！叫上朋友出去玩",
        traitScores: { A: 0, C: 0, E: -1, O: 1, X: 4, P: 4 }
      },
      {
        value: "B",
        text: "自己出门走走，享受阳光",
        traitScores: { A: 0, C: 0, E: 1, O: 1, X: 1, P: 0 }
      },
      {
        value: "C",
        text: "在家里待着，开窗晒晒太阳就好",
    ...
    options: [
      {
        value: "A",
        text: "直接指出问题，不怕讨论冲突",
        traitScores: { A: -2, C: 0, E: 3, O: 3, X: 1, P: 0 }
      },
      {
        value: "B",
        text: "委婉提出不同看法，注意措辞",
      ...
      },
      {
        value: "D",
        text: "表面附和，心里不认同",
        traitScores: { A: 0, C: -1, E: -2, O: -2, X: 0, P: 0 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -1, E: -1, O: 0, X: 2, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -1, E: -1, O: 3, X: -1, P: 0 }
      },
      {
        value: "D",
        text: "我不太确定...我更多是享受参与，而非扮演特定角色",
        traitScores: { A: -3, C: -1, E: 3, O: -3, X: -1, P: -3 }
      },
      {
        value: "E",
        text: "我能确保事情顺利运行，考虑周全",
        traitScores: { A: 0, C: 4, E: 0, O: 0, X: 0, P: 0 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "冷场，或者气氛尴尬",
        traitScores: { A: 0, C: -1, E: -1, O: 0, X: 1, P: 3 }
      },
      {
        value: "B",
    ...
    options: [
      {
        value: "A",
        text: "火花塞",
        traitScores: { A: -1, C: -2, E: -2, O: -1, X: 3, P: 2 }
      },
      {
        value: "B",
        text: "粘合剂",
        traitScores: { A: 3, C: 0, E: -1, O: -2, X: -1, P: 0 }
      },
      {
        value: "C",
        text: "指南针",
        traitScores: { A: -1, C: 2, E: 0, O: 0, X: 0, P: -1 }
      },
      {
        value: "D",
        text: "观察者",
        traitScores: { A: -1, C: 0, E: 3, O: 3, X: -2, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: -3, C: -1, E: 0, O: 1, X: 3, P: -2 }
      },
      {
        value: "B",
        text: "让周围的人感到舒服更重要。和谐的关系需要适当的调整",
        traitScores: { A: 3, C: 0, E: -2, O: -1, X: -2, P: 1 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -2, E: 0, O: 0, X: 0, P: 1 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: -2, C: -1, E: 2, O: 1, X: -3, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -1, E: 0, O: 0, X: 2, P: 3 }
      },
      {
        value: "D",
        text: "老实说，我不太擅长处理别人的情绪问题",
        traitScores: { A: -4, C: -1, E: 0, O: 0, X: -3, P: -4 }
      },
      {
        value: "E",
        text: "分享我相关的经历和感受，让ta知道并不孤单",
        traitScores: { A: 1, C: -1, E: 0, O: 0, X: 1, P: 1 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 3, C: 0, E: -1, O: 0, X: 0, P: 2 }
      },
      {
        value: "C",
      ...
      },
      {
        ...
        traitScores: { A: -4, C: 0, E: 0, O: 0, X: -3, P: -4 }
      },
      {
        value: "E",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 1, C: 1, E: 1, O: 0, X: 0, P: 2 }
      },
      {
        value: "D",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 1, C: -1, E: 0, O: 0, X: -1, P: 0 }
      },
      {
        value: "C",
    ...
    options: [
      {
        ...
        traitScores: { A: 5, C: -1, E: -1, O: 0, X: 0, P: 0 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 5, E: 0, O: 0, X: 0, P: 0 }
      },
      {
        value: "E",
        text: "活动快点结束，我能回家充电",
        traitScores: { A: -2, C: -1, E: 1, O: -3, X: -2, P: -3 }
      },
      {
        value: "F",
  ...
  // 反向计分题1 - 用于检测作答一致性
  {
    ...
    options: [
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -1, E: -1, O: 0, X: 4, P: 2 }
      },
      {
        value: "D",
    ...
    options: [
      {
        value: "A",
        text: "几秒钟就过去了，不会放在心上",
        traitScores: { A: 0, C: 0, E: 4, O: 0, X: 2, P: 3 }
      },
      {
        value: "B",
    ...
    options: [
      {
        value: "A",
        text: "保持冷静，迅速想办法应对",
        traitScores: { A: 0, C: 2, E: 3, O: 0, X: 0, P: 2 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: 0, C: -1, E: -3, O: 0, X: 0, P: -1 }
      }
    ]
  },
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: 0, E: 3, O: 0, X: 0, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        ...
        traitScores: { A: 0, C: 0, E: -1, O: 0, X: 1, P: -1 }
      },
      {
        value: "D",
    ...
    options: [
      {
        ...
        traitScores: { A: 4, C: -1, E: -3, O: 0, X: 1, P: 0 }
      },
      {
        value: "B",
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -1, E: -1, O: 0, X: 3, P: 0 }
      },
      {
        value: "B",
    ...
    options: [
      {
        ...
        traitScores: { A: 3, C: -2, E: 0, O: -1, X: 2, P: 0 }
      },
      {
        value: "B",
        text: "自己按照系统的教程一步一步来",
        traitScores: { A: -1, C: 4, E: 0, O: -2, X: -1, P: -1 }
      },
      {
        value: "C",
        text: "边做边学，遇到问题再查资料",
        traitScores: { A: -1, C: -2, E: 0, O: 1, X: 0, P: 2 }
      },
      {
        value: "D",
    ...
    options: [
      {
        value: "A",
        text: "走！这种刺激的我最喜欢了！",
        traitScores: { A: 0, C: -1, E: -2, O: 2, X: 1, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "D",
        text: "这种我不太行，有没有其他选择？",
        traitScores: { A: 0, C: 0, E: 1, O: -1, X: -1, P: -2 }
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        value: "B",
        text: "边玩边搞笑，制造欢乐氛围",
        traitScores: { A: 0, C: -1, E: -2, O: 0, X: 2, P: 4 }
      },
      {
        value: "C",
        text: "观察每个人的玩法风格，很有趣",
        traitScores: { A: 3, C: -1, E: 0, O: 1, X: -1, P: -1 }
      },
      {
        value: "D",
        text: "希望规则简单点，复杂的有点累",
        traitScores: { A: -1, C: -1, E: 3, O: -1, X: -1, P: -1 }
      }
    ]
  },
  {
    ...
    options: [
      {
        ...
        traitScores: { A: 0, C: -1, E: -2, O: 0, X: 3, P: 2 }
      },
      {
        value: "B",
    ...
    options: [
      {
        value: "A",
        text: "超开心！继续抖包袱",
        traitScores: { A: 0, C: -1, E: -2, O: 0, X: 3, P: 4 }
      },
      {
        value: "B",
        text: "有点小得意，自然流露就好",
      ...
      },
      {
        value: "D",
        text: "笑完就过了，不太在意",
        traitScores: { A: 0, C: 1, E: 1, O: 0, X: -3, P: -3 }
      }
    ]
  },
  {
    ...
    options: [
      {
        value: "A",
        text: "超期待！每天都在猜测是什么",
        traitScores: { A: 0, C: -1, E: -1, O: 3, X: 0, P: 3 }
      },
      {
        value: "B",
      ...
      },
      {
        value: "C",
        text: "平常心，到时候知道就知道了",
        traitScores: { A: 0, C: -1, E: 3, O: -1, X: 0, P: -1 }
      },
      {
        value: "D",
        text: "其实更希望直接告诉我，不太喜欢等待",
        traitScores: { A: 0, C: 2, E: 0, O: -2, X: 0, P: -2 }
      }
    ]
  },

  // E/P precision items, E anchor, E/A bridge items, and consistency-pair
  // seconds were extracted verbatim to questionsV4ExtendedPart2.ts to keep
  // this module under the harness file-size limit. Ordering is unchanged.
  ...questionsV4ExtendedPart2
];
