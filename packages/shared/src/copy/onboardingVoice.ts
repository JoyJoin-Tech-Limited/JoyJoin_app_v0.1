...
const TIER_B_LINES: Record<OnboardingVoiceStepId, string> = {
  ...
  'essential-submit-success': '入场名片已保存——马上就好，去看你的兴趣热度。',
  'essential-back': '回去改一下没关系，我记着呢。',
...
const TIER_A_LINES: ArchetypeVoiceMap = {
  corgi: {
    ...
    'essential-submit-success': '名片收好了，柯基！下一站选兴趣，马上就能去点燃第一桌。',
    'essential-back': '回头改一下没问题，柯基——场子还在，慢慢来。',
  ...
  rooster: {
    ...
    'essential-submit-success': '名片稳稳收下，小太阳——下一步点亮兴趣，节奏刚刚好。',
    'essential-back': '回头再改没问题，小太阳——稳妥的人不赶时间。',
  ...
  hamster_praise: {
    ...
    'essential-submit-success': '名片收好啦，仓鼠——再挑几个兴趣，你的好眼光就藏不住了。',
    'essential-back': '回头改一下没关系，仓鼠——慢慢填，我在呢。',
  ...
  fox: {
    ...
    'essential-submit-success': '名片已入袋，狐狸——下一站淘兴趣，宝藏马上登场。',
    'essential-back': '回头翻改没问题，狐狸——好东西值得多看一眼。',
  ...
  dolphin_calm: {
    ...
    'essential-submit-success': '名片已收好，海豚——再选几个兴趣，一切都会很顺。',
    'essential-back': '回头调整没关系，海豚——按你的节奏来。',
  ...
  spider: {
    ...
    'essential-submit-success': '名片已入库，织网师——再标几个兴趣，网就织好了。',
    'essential-back': '回头补一个结点没关系，织网师——网会越织越稳。',
  ...
  koala: {
    ...
    'essential-submit-success': '名片收好了，考拉——接下来选兴趣，不用急。',
    'essential-back': '回头改一下没关系，考拉——放松点，我等你。',
  ...
  octopus: {
    ...
    'essential-submit-success': '名片已捕获，章鱼——下一站兴趣区，脑洞继续开。',
    'essential-back': '回头改一笔没关系，章鱼——灵感随时可以回来。',
  ...
  owl: {
    ...
    'essential-submit-success': '名片已归档，猫头鹰——再挑几个想深聊的话题吧。',
    'essential-back': '回头斟酌一下没关系，猫头鹰——好答案值得推敲。',
  ...
  elephant: {
    ...
    'essential-submit-success': '名片已稳妥收下，大象——下一步选兴趣，继续稳稳走。',
    'essential-back': '回头改一下没关系，大象——踏实的人总能把事情做好。',
  ...
  turtle: {
    ...
    'essential-submit-success': '名片收好了，龟龟——下一步选兴趣，按你的速度来。',
    'essential-back': '回头改一下没关系，龟龟——慢慢来，都来得及。',
  ...
  cat: {
    ...
    'essential-submit-success': '名片已收下，猫猫——再标几个兴趣，对味的就出来了。',
    'essential-back': '回头调整没关系，猫猫——值得的才值得改。',
