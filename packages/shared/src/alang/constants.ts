export const ALANG_STORAGE_KEY_PREFIX = "jj_alang_" as const;
export const ALANG_ACTIVE_MISSION_KEY = "jj_alang_active_mission" as const;

export const ALANG_GPS_INTERVAL_MS = 3000;
...
export const ALANG_HAPTIC_SUCCESS = "success" as const;
