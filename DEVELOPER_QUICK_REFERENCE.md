...
- The public edge is the self-managed remote server plus host Nginx using `deployment/nginx/joyjoin.conf` (`yuejuapp.com`, `www.yuejuapp.com`, `admin.yuejuapp.com`, `api.yuejuapp.com`). This is the active production path; do not revive old Fly.io deployment assumptions in active docs or scripts.
