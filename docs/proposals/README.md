...
| [`supervisor-smart-suggested-actions.md`](./supervisor-smart-suggested-actions.md) | **Open design** | Runtime-scored next-action engine for Supervisor; keep native buttons static and minimal while dynamic routing text and future companion surfaces carry session-aware recommendations. |
