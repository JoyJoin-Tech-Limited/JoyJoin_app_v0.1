...
> **Last updated:** 2026-06-04 (Batch C + D Lovart asset wiring shipped via Path B local-bundle: 11 surfaces wired across ceremony/achievement dimensions; 8 ceremony + 9 badge WebP bundled at q=55, 600px; main package 1.98MB zip; ceremonies/badges use `localAsset()` while other Lovart Batches A/B remain CDN).
