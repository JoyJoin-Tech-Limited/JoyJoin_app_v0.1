...
### 3.6 Modified: `scripts/orchestration/orchestration-supervisor.mjs` (git-hook mode)
...
node scripts/orchestration/orchestration-supervisor.mjs git-hook post-commit || true
