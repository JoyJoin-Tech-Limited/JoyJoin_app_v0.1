# Monte Carlo Group-Formation Harness — 2026-09-11
...
|---|---|---|
| (i) min-E ≥ 25 | 100.0% | 2846 |
| (ii) mean-A ≥ 45 | 100.0% | 2846 |
| (iii-a) ≥1 spark | 100.0% | 2846 |
| (iii-b) ≤1 spark | n/a (0 evaluated) | 0 |
| (iv) var(X) ≤ 750 | 100.0% | 2846 |

**Raw (pre-exemption) composition picture under gates-ON:**

| Measurement | Baseline (gates OFF) | Gates ON |
|---|---|---|
| spark 0 / 1 / 2+ | 6.1% / 14.6% / 79.3% | 0.0% / 15.0% / 85.0% |
| min-E < 25 | 0.8% | 0.0% |
| mean-A < 45 | 2.0% | 0.0% |
| var(X) > 750 (shipped cap) | 2.5% | 0.0% |
| unmatched rate (mean) | 11.1% | 6.9% |
...
|---|---|---|
| (i) min-E floor | 0 | 21 |
| (ii) mean-A floor | 175 | 29 |
| (iii) spark rule | 143 | 0 |
| (iv) X-variance cap | 24 | 51 |
| (W2) R1 no-isolate | 545 | 317 |
| (W2) R2 energizer | 143 | 0 |
| **total groups rejected** | 995 | 418 |

**M9 (LOCKED ≥ 95.0% all-gates pass, exemption-aware): ✅ PASS** — 100.0% of 2846 committed groups.
**M10 (LOCKED ≤ +2pp unmatched): ✅ PASS** — delta -4.23pp vs gate-off baseline (11.1% → 6.9%).
