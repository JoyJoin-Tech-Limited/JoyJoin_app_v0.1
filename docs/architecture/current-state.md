...
- `deployment/nginx/joyjoin.conf` is the public edge configuration for host Nginx serving `yuejuapp.com`, `www.yuejuapp.com`, `admin.yuejuapp.com`, and `api.yuejuapp.com`.
