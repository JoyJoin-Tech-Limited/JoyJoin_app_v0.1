...
| `generateProfileTagline` | `apps/server/src/profileTaglineService.ts` | DeepSeek | Flash non-thinking | Short expressive onboarding copy; prompt injects `XIAOYUE_CRAFT_LITE` for warm, concrete copy |
