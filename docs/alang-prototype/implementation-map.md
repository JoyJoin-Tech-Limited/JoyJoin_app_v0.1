...
- **2026-07-25 任务体验覆盖：**30 条旧“到地点验收”任务改为 25 条无惩罚生活邀请 + 5 条数字 NPC 传话。生活邀请覆盖城市出发、电影/阅读/音乐、轻运动、一直想做的小事和熟人连接；不打卡、不要求证明。NPC 传话只发生在五位虚构数字动物之间，必须在之后真实解锁目标 NPC 时回访，绝不要求用户接触现实陌生人。用户可回答做了、开始了一点、没做、改变主意或忘记；任何结果都不扣分、不发奖励、不影响匹配或正式人格。
