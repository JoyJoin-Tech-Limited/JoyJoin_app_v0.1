...
See [references/approaches.md](references/approaches.md) for full step-by-step instructions, auth bypass pattern, mock server setup, known traps, and detailed code snippets.
