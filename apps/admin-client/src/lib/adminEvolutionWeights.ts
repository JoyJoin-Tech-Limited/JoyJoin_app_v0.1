...
export const WEIGHT_DIMENSIONS = [
  {
    key: "chemistryWeight",
    label: "化学反应",
    alphaKey: "chemistryAlpha",
    betaKey: "chemistryBeta",
    color: "#8b5cf6",
  },
  {
    key: "interestWeight",
    label: "兴趣重叠",
    alphaKey: "interestAlpha",
    betaKey: "interestBeta",
    color: "#3b82f6",
  },
  {
    key: "socialAffinityWeight",
    label: "社交同频",
    alphaKey: "socialAffinityAlpha",
    betaKey: "socialAffinityBeta",
    color: "#22c55e",
  },
  {
    key: "backgroundDiversityWeight",
    label: "背景多样性",
    alphaKey: "backgroundDiversityAlpha",
    betaKey: "backgroundDiversityBeta",
    color: "#f97316",
  },
  {
    key: "preferenceWeight",
    label: "活动偏好",
    alphaKey: "preferenceAlpha",
    betaKey: "preferenceBeta",
    color: "#ec4899",
  },
  {
    key: "languageWeight",
    label: "语言沟通",
    alphaKey: "languageAlpha",
    betaKey: "languageBeta",
    color: "#06b6d4",
  },
] as const;
