  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <span className={`${textSizes[size]} font-bold`} style={{ fontFamily: '"PingFang SC", "Noto Sans SC", sans-serif' }}>悦聚</span>
        {showEnglish && (
          <>
            <span className="text-muted-foreground">·</span>
            <span className={`${textSizes[size]} font-semibold text-muted-foreground`} style={{ fontFamily: '"Outfit", system-ui, sans-serif' }}>JoyJoin</span>
          </>
        )}
      </div>
    </div>
