        ...
        <div className="px-4 py-4">
          <Card className="border shadow-sm">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-semibold mb-2">暂无活动互动</h3>
              <p className="text-sm text-muted-foreground">
                参加活动后，互动将在活动开始前24小时开放
              </p>
            </CardContent>
          </Card>
        </div>
              ...
              >
                {isLocked ? (
                  <div className="bg-muted text-muted-foreground px-4 py-2.5 flex items-center gap-2">
                    ...
                    <span className="text-base font-bold">互动 {countdown} 开放</span>
                  </div>
                ) : (
                  <div className="bg-primary text-primary-foreground px-4 py-2 flex items-center gap-2">
                    <MessageSquare className="h-4 w-4 flex-shrink-0" />
                    <span className="font-semibold text-sm">互动已开放</span>
                    {isPast && (
