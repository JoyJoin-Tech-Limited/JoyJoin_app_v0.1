...
export const FLASH_UNIVERSAL_ART = '/pages/alang/assets/flash-city-encounter.png'
...
const npcThemes: FlashNpcTheme[] = [
  {
    ...
    name: '阿浪',
    animal: '灰狼',
    imageSrc: '/pages/alang/assets/npcs/alang.png',
    fallbackGlyph: '浪',
    accent: '#64748B',
    tint: '#F0F2F7',
    ink: '#3E4658',
  },
  {
    ...
    name: '栗子',
    animal: '水獭',
    imageSrc: '/pages/alang/assets/npcs/lizi.png',
    fallbackGlyph: '栗',
    accent: '#F97360',
    tint: '#FFF2E9',
    ink: '#70402B',
  },
  {
    ...
    name: '默默',
    animal: '兔狲',
    imageSrc: '/pages/alang/assets/npcs/momo.png',
    fallbackGlyph: '默',
    accent: '#829AB1',
    tint: '#F3F0EC',
    ink: '#48433F',
  },
  {
    ...
    name: '拾柒',
    animal: '乌鸦',
    imageSrc: '/pages/alang/assets/npcs/shiqi.png',
    fallbackGlyph: '柒',
    accent: '#5B5266',
    tint: '#F1EFF8',
    ink: '#37324D',
  },
  {
    ...
    name: '阿团',
    animal: '水豚',
    imageSrc: '/pages/alang/assets/npcs/atuan.png',
    fallbackGlyph: '团',
    accent: '#8DA399',
    tint: '#F0F5EC',
    ink: '#43543A',
