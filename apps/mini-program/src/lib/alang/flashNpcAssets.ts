...
import alangDialogueScene from '../../pages/alang/assets/ui/flash-alang-first-act-riverside-v3.webp'
import atuanDialogueScene from '../../pages/alang/assets/ui/flash-atuan-first-arrival-layered-v2.jpg'
import liziDialogueScene from '../../pages/alang/assets/ui/flash-lizi-first-act-color-studio-v2.jpg'
import momoDialogueScene from '../../pages/alang/assets/ui/flash-momo-first-act-rain-route-v3.webp'
import shiqiDialogueScene from '../../pages/alang/assets/ui/flash-shiqi-first-act-record-room-v3.webp'
