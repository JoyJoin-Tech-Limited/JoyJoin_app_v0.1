...
import alangDialogueScene from '../../pages/alang/assets/ui/flash-alang-first-act-riverside-v1.jpg'
import atuanDialogueScene from '../../pages/alang/assets/ui/flash-atuan-first-arrival-layered-v2.jpg'
import liziDialogueScene from '../../pages/alang/assets/ui/flash-lizi-first-act-color-studio-v1.jpg'
import momoDialogueScene from '../../pages/alang/assets/ui/flash-momo-first-act-rain-route-v1.jpg'
import shiqiDialogueScene from '../../pages/alang/assets/ui/flash-shiqi-first-act-record-room-v1.jpg'
