...
export const XIAOYUE_EXPRESSION_MATRIX: XiaoyueExpressionMatrixRow[] = [
  ...
  {
    flow: '氛围测试',
    surface: 'personality-test testing — choice question',
    primaryTier: 'supplement',
    secondaryTag: 'test.curious',
    expressionId: 'testCurious',
  },
  {
    flow: '氛围测试',
    surface: 'personality-test testing — slider question',
    primaryTier: 'supplement',
    secondaryTag: 'test.listening',
    expressionId: 'testListening',
  },
  {
    flow: '氛围测试',
    surface: 'personality-test testing — answer acknowledged',
    primaryTier: 'actionSuccess',
    secondaryTag: 'test.nod',
    expressionId: 'testNod',
  },
  {
    flow: '氛围测试',
    surface: 'personality-test testing — milestone Q4/Q8',
    primaryTier: 'matchSuccess',
    secondaryTag: 'test.surprised',
    expressionId: 'testSurprised',
  },
  {
    flow: '资料',
  ...
  {
    flow: '信息',
    surface: 'subpackages/profile-linked/terms/index',
    primaryTier: 'supplement',
