...
const DINING_HERO_SUBPACKAGE = '/subpackages/pool-registration/assets/ceremony/lovart-pool-registration-hero-dining-20260702-v2.webp'
const DRINKS_HERO_SUBPACKAGE = '/subpackages/pool-registration/assets/ceremony/lovart-pool-registration-hero-drinks-20260702-v2.webp'
