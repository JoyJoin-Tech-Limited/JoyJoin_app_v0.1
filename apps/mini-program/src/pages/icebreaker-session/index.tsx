...
export default function IcebreakerSessionPage() {
  ...
  const phaseViewsProps: SessionPhaseViewsProps = {
    ...
    onMiniScriptPresentEvidence: handlePresentEvidence,
    onMiniScriptConfirmRead: handleConfirmRead,
    onMiniScriptAdvanceCeremony: handleAdvanceCeremony,
    onMiniScriptOpenMotiveVote: handleOpenMotiveVote,
