...
export default function MomentCardView({ payload, visible, onClose }: MomentCardViewProps) {
  ...
  const drawCard = useCallback(() => {
    ...
    ctx.setFillStyle('#d4af37'); // muted gold, not pure #ffd700
    ...
    >
      ...
      >
        {canvasFailed ? (
          ...
          >
            <Text style={{ color: '#d4af37', fontSize: '32rpx', fontWeight: 'bold', marginBottom: '16rpx' }}>
              JoyJoin
            </Text>
            <Text style={{ color: '#aaaaaa', fontSize: '28rpx', textAlign: 'center', marginBottom: '32rpx' }}>
              生成回忆卡失败，请重试
            </Text>
            <View
              onClick={(e) => {
