...
app.get("/api/my-pool-registrations", requireAuth, async (req, res) => {
  ...
  const INDUSTRY_MATCHERS: { value: string; keywords: string[] }[] = [
    { value: "tech", keywords: ["互联网", "科技", "tech", "ai", "it", "大厂", "程序员", "码农", "字节", "腾讯", "阿里", "百度", "美团", "华为", "bat", "tmd", "软件", "开发", "社畜", "打工人", "大疆", "小米", "oppo", "vivo", "网易", "京东", "拼多多", "快手"] },
    { value: "finance", keywords: ["金融", "finance", "bank", "investment", "投资", "银行", "基金", "pe", "vc", "投行", "量化", "证券", "保险", "会计", "审计", "四大"] },
    { value: "creative", keywords: ["创意", "设计", "creative", "design", "舞蹈", "跳舞", "表演", "演员", "歌手", "音乐", "文化", "娱乐", "文娱", "艺术", "艺人", "街舞", "芭蕾", "编舞", "摄影", "视频", "剪辑", "插画", "画画", "美工", "ui", "ux", "dj", "打碟", "唱歌", "乐队"] },
    { value: "media", keywords: ["媒体", "内容", "传媒", "博主", "kol", "网红", "主播", "直播", "自媒体", "公众号", "小红书", "抖音", "b站", "up主"] },
    { value: "lifestyle", keywords: ["生活服务", "lifestyle", "健身", "瑜伽", "咖啡", "美容", "美发", "宠物", "餐饮", "私教", "教练", "厨师", "调酒", "茶艺", "花艺"] },
    { value: "education", keywords: ["教育", "education", "edu", "老师", "教师", "培训", "讲师", "教授", "学校", "大学"] },
    { value: "consulting", keywords: ["咨询", "consulting", "mbb", "麦肯锡", "波士顿", "贝恩", "埃森哲", "猎头", "hr", "人力"] },
    { value: "legal", keywords: ["法律", "legal", "律师", "律所", "法务", "合规", "金杜", "中伦", "方达"] },
    { value: "medical", keywords: ["医疗", "医药", "健康", "health", "医生", "护士", "医院", "制药", "生物", "心理咨询"] },
    { value: "hardware", keywords: ["硬科技", "芯片", "半导体", "ic", "嵌入式", "硬件", "电子"] },
    { value: "new_energy", keywords: ["新能源", "汽车", "电动车", "比亚迪", "特斯拉", "蔚来", "理想", "小鹏", "电池", "自动驾驶"] },
    { value: "ecommerce", keywords: ["电商", "跨境", "亚马逊", "淘宝", "天猫", "拼多多", "独立站", "shopify", "运营", "选品"] },
    { value: "realestate", keywords: ["地产", "房地产", "real estate", "建筑", "物业", "装修", "室内设计", "景观"] },
    { value: "hospitality", keywords: ["酒店", "旅游", "航空", "空乘", "导游", "旅行", "空姐", "空少", "机场"] },
    { value: "other", keywords: ["公务员", "政府", "事业单位", "体制内", "国企", "央企", "自由职业", "创业", "外企", "500强", "制造", "工厂", "生产"] },
  ];
