            ...
            try {
              ...
              if (existing.length === 0) {
                await storage.createNotification({
                  userId: otherUserId,
                  // Mutual matches are part of the post-event connections flow, not chat.
                  category: 'activities',
                  type: 'mutual_match',
                  title: '🎉 新的双向匹配',
