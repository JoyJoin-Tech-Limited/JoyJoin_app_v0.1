...
const MANUAL_OVERRIDES = new Map<string, SeedMatch>([
  ...
  ['画家', { category: 'culture_sports', segment: 'performing_arts', confidence: 1.0 }],
  ['雕塑家', { category: 'culture_sports', segment: 'performing_arts', confidence: 1.0 }],
  ['书法家', { category: 'culture_sports', segment: 'performing_arts', confidence: 1.0 }],
  ['陶艺师', { category: 'culture_sports', segment: 'performing_arts', confidence: 1.0 }],
  ...
  ['策展人', { category: 'culture_sports', segment: 'performing_arts', confidence: 1.0 }],
  ['艺术评论家', { category: 'culture_sports', segment: 'performing_arts', confidence: 1.0 }],
  ['诗人', { category: 'media_creative', segment: 'marketing', confidence: 1.0 }],
  ...
  ['电工', { category: 'real_estate', segment: 'construction', confidence: 1.0 }],
  ['水电工', { category: 'real_estate', segment: 'construction', confidence: 1.0 }],
  ['修理工', { category: 'real_estate', segment: 'construction', confidence: 1.0 }],
  ['装修工', { category: 'real_estate', segment: 'construction', confidence: 1.0 }],
