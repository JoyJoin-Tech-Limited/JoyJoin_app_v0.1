...
export const INDUSTRY_ONTOLOGY: IndustryCategory[] = [
  ...
  {
    name: '科技/互联网',
    aliases: ['科技', '互联网', 'IT', 'tech', '技术', '大厂', '互联网公司'],
    keywords: ['科技', '互联网', '技术', '软件', '开发', '程序', 'IT', 'tech', '大厂', 'BAT', 'TMD', '字节', '腾讯', '阿里', '百度', '美团', '京东', '拼多多', '快手', '网易', '华为', '小米', 'OPPO', 'vivo', '大疆', '深信服', '迈瑞', '社畜', '打工人', '互联网人', '码农', '程序员', 'IT民工', '微软', '谷歌', '亚马逊', '苹果', 'Meta', 'Facebook', 'Google', 'Microsoft', 'Apple', 'Amazon'],
    segments: [
      {
        name: '研发/开发',
  ...
  {
    name: '文化娱乐',
    aliases: ['创意设计', '文娱', '娱乐', 'creative', 'entertainment', '文化', '艺术'],
    keywords: ['文化', '娱乐', '创意', '设计', '艺术', '表演', '演出', '文娱', '艺人'],
    segments: [
      {
        name: '表演艺术',
        aliases: ['舞蹈', '音乐', '戏剧', 'performing arts'],
        commonPositions: ['舞者', '舞蹈老师', '编舞', '演员', '歌手', '音乐人', '乐手'],
        keywords: ['跳舞', '舞蹈', '跳舞的', '街舞', '芭蕾', '拉丁舞', '现代舞', '国标舞', '民族舞', '编舞', '舞者', '唱歌', '歌手', '音乐', '乐队', '演员', '表演', '话剧', '戏剧', '相声', '脱口秀', 'DJ', '打碟', '夜店']
      },
      {
        name: '视觉设计',
        aliases: ['平面设计', '视觉传达', 'graphic design'],
        commonPositions: ['设计师', '美工', 'UI设计师', '视觉设计师', '平面设计师'],
        keywords: ['设计', '美工', 'UI', '视觉', '平面', '海报', '插画', '画画', '绘画', 'Photoshop', 'PS', 'AI', 'Illustrator', 'Figma', 'Sketch']
      },
      {
        name: '影视制作',
        aliases: ['视频', '影视', '电影', 'film', 'video'],
        commonPositions: ['导演', '编剧', '剪辑师', '摄影师', '摄像师'],
        keywords: ['拍视频', '视频', '电影', '短片', '剪辑', '后期', '摄影', '摄像', '导演', '编剧', '特效', 'Premiere', 'PR', 'Final Cut', '达芬奇']
      },
      {
        name: '时尚/造型',
        aliases: ['时尚', '美妆', 'fashion', 'beauty'],
        commonPositions: ['化妆师', '造型师', '服装设计师', '模特', '美甲师'],
        keywords: ['时尚', '美妆', '化妆', '造型', '服装', '穿搭', '模特', 'T台', '走秀', '美甲', '美睫', '发型师', 'Tony老师']
      },
      {
        name: '游戏/动漫',
        aliases: ['游戏', '动漫', 'gaming', 'animation'],
        commonPositions: ['游戏策划', '游戏设计师', '原画师', '3D建模师', '动画师'],
        keywords: ['游戏', '电竞', '主播', '游戏主播', '动漫', '二次元', '原画', '3D建模', '动画', 'CG', '游戏开发']
      }
    ]
  },
  ...
  {
    name: '生活服务',
    aliases: ['服务业', '生活方式', 'lifestyle', 'service'],
    keywords: ['健身', '瑜伽', '咖啡', '餐饮', '美容', '宠物', '生活'],
    segments: [
      {
        name: '健身运动',
        aliases: ['健身', '运动', 'fitness'],
        commonPositions: ['健身教练', '私教', '瑜伽老师', '游泳教练'],
        keywords: ['健身', '私教', '健身教练', '瑜伽', '普拉提', '游泳', '跑步', '运动', 'CrossFit', '撸铁', '增肌', '减脂', '健身房']
      },
      {
        name: '餐饮/咖啡',
        aliases: ['餐饮', '咖啡', 'F&B', 'food'],
        commonPositions: ['厨师', '咖啡师', '调酒师', '甜点师', '餐厅经理'],
        keywords: ['咖啡', '咖啡师', '餐厅', '开店', '餐饮', '厨师', '烘焙', '甜点', '蛋糕', '酒吧', '调酒', '鸡尾酒', '茶艺', '品酒']
      },
      {
        name: '美容/美发',
        aliases: ['美容', '美发', 'beauty'],
        commonPositions: ['美容师', '美发师', '造型师', '纹绣师'],
        keywords: ['美容', '美发', '理发', '发型', '护肤', 'SPA', '按摩', '养生', '纹眉', '美甲']
      },
      {
        name: '宠物服务',
        aliases: ['宠物', 'pet'],
        commonPositions: ['宠物美容师', '宠物医生', '训犬师'],
        keywords: ['宠物', '猫', '狗', '宠物店', '宠物医院', '兽医', '训犬', '铲屎官']
      }
    ]
  }
];
