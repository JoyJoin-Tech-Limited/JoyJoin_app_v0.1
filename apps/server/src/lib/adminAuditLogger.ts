...
export const ADMIN_AUDIT_ACTIONS = [
  ...
  'FLASH_UPCOMING_SHIFT_UPDATED',
  'FLASH_UPCOMING_SHIFT_CANCELLED',
  'FLASH_MANUAL_HOLD_STARTED',
  'FLASH_MANUAL_HOLD_STOPPED',
  'FLASH_STORY_EPISODE_UPDATED',
  'FLASH_STORY_EPISODE_REVIEWED',
  'FLASH_STORY_SEASON_PUBLISHED',
