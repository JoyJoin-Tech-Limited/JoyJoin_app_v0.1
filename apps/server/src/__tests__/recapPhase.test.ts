...
const PHASE_CONFIG = {
  ...
  speed_friending: { emoji: '', name: '快速交友', nameEn: 'Speed Friending', gradient: 'from-green-400 to-emerald-500', bgGradient: 'from-green-50 via-emerald-50 to-teal-50', darkBgGradient: 'from-green-950 via-emerald-950 to-zinc-900', pillColor: 'bg-green-100/80 text-green-700', timeoutMinutes: 30, minPlayersRequired: 2 },
