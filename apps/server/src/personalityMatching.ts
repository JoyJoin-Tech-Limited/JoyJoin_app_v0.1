...
const archetypeTraitVectors: Record<string, UserTraitVector> = {
  "corgi": { A: 62, O: 58, C: 57, E: 68, X: 66, P: 66 },  // 最活泼外向
  "rooster": { A: 64, O: 60, C: 64, E: 72, X: 58, P: 64 },    // 稳重积极
  "hamster_praise": { A: 66, O: 60, C: 60, E: 68, X: 62, P: 62 },    // 热情赞美
  "fox": { A: 58, O: 68, C: 60, E: 66, X: 60, P: 56 },    // 机敏多思
  "dolphin_calm": { A: 62, O: 62, C: 62, E: 72, X: 56, P: 58 },  // 淡然从容
  "spider": { A: 68, O: 65, C: 60, E: 66, X: 54, P: 56 },    // 细腻连接
  "koala": { A: 72, O: 58, C: 58, E: 68, X: 54, P: 62 },    // 温暖关怀
  "octopus": { A: 58, O: 72, C: 54, E: 66, X: 56, P: 56 },  // 创意发散
  "owl": { A: 56, O: 66, C: 68, E: 66, X: 52, P: 54 }, // 深思熟虑
  "elephant": { A: 62, O: 58, C: 70, E: 74, X: 56, P: 56 },  // 稳重可靠
  "turtle": { A: 58, O: 60, C: 66, E: 70, X: 50, P: 50 },    // 沉稳保守
  "cat": { A: 56, O: 56, C: 62, E: 68, X: 48, P: 54 },    // 内敛观察
};
