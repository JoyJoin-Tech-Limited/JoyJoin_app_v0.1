...
function transformToUnifiedResult(result: AssessmentResult, completedAt: string): UnifiedAssessmentResult {
  return {
    ...
    affinityScore: (result.traitScores.A || 0) * 100,
    opennessScore: (result.traitScores.O || 0) * 100,
    conscientiousnessScore: (result.traitScores.C || 0) * 100,
    emotionalStabilityScore: (result.traitScores.E || 0) * 100,
