...
export const archetypeShareVariants: Record<string, ShareCardVariant[]> = {
  "机智狐": [
    ...
    { name: "日落金", gradient: "from-amber-400 via-orange-400 to-red-400", primaryColor: "#F59E0B", mood: "温暖热情，灵感迸发" },
  ...
  "开心柯基": [
    ...
    { name: "桃子橙", gradient: "from-orange-300 via-pink-300 to-rose-400", primaryColor: "#FB923C", mood: "温暖治愈，笑容甜美" },
  ],
  "暖心熊": [
    ...
    { name: "巧克力", gradient: "from-orange-700 via-amber-700 to-yellow-600", primaryColor: "#D97706", mood: "醇厚温暖，陪伴温馨" },
  ...
  "织网蛛": [
    ...
    { name: "暗夜黑", gradient: "from-slate-700 via-gray-700 to-zinc-700", primaryColor: "#475569", mood: "低调神秘，精心布局" },
  ...
  "夸夸豚": [
    ...
    { name: "紫霞光", gradient: "from-purple-300 via-pink-300 to-rose-300", primaryColor: "#C084FC", mood: "温柔甜美，笑容灿烂" },
  ],
  "太阳鸡": [
    ...
    { name: "晨曦粉", gradient: "from-pink-400 via-orange-300 to-yellow-300", primaryColor: "#FB923C", mood: "温柔明媚，希望之光" },
  ...
  "淡定海豚": [
    ...
    { name: "薄雾灰", gradient: "from-slate-400 via-gray-400 to-blue-300", primaryColor: "#94A3B8", mood: "淡然优雅，处变不惊" },
  ...
  "沉思猫头鹰": [
    ...
    { name: "星空黑", gradient: "from-slate-800 via-gray-800 to-zinc-800", primaryColor: "#1E293B", mood: "静谧深邃，哲思绵绵" },
  ...
  "稳如龟": [
    ...
    { name: "石板灰", gradient: "from-slate-600 via-gray-600 to-zinc-600", primaryColor: "#475569", mood: "低调务实，稳定如山" },
  ...
  "隐身猫": [
    ...
    { name: "月影银", gradient: "from-slate-400 via-gray-400 to-zinc-400", primaryColor: "#94A3B8", mood: "优雅内敛，独立自在" },
  ...
  "定心大象": [
    ...
    { name: "深海沉静", gradient: "from-indigo-700 via-blue-700 to-cyan-700", primaryColor: "#4338CA", mood: "深沉稳重，定海神针" },
  ...
  "灵感章鱼": [
    ...
    { name: "极光多彩", gradient: "from-pink-400 via-purple-400 to-cyan-400", primaryColor: "#EC4899", mood: "多彩绚烂，创意无穷" },
