...
**Events / Footprint tab — FootprintOracleCard (2026-06-30):**
- **`FootprintOracleCard`** (`apps/mini-program/src/components/events/FootprintOracleCard.tsx`) — interactive event card for the "足迹" tab list. Wraps `EventSummaryCard` with list affordances (tap, hover, footer hint, index-based entrance delay). Haptic feedback on tap; reduced-motion/degradation tier disables entrance delay.
