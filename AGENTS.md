...
- **孤字 guard (2026-06-08):** CJK text blocks use `word-break: keep-all; overflow-wrap: break-word;` to prevent single-character dangling lines (e.g., bubble text, reveal title, bridge lines).
