...
- If the active agent has execute access and is responsible for persistence, append the summary through `node scripts/orchestration/orchestration-supervisor.mjs record-summary`.
