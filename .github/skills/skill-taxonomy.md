...
>
> **OpenCode mirror:** `.agents/skills/` contains a parallel skill tree auto-discovered by OpenCode. It is a subset (62 skills) of the canonical `.github/skills/` tree (76 skills). See **Unhandled** in the latest `docs-sync` summary for sync status.
