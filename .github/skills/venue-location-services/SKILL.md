...
For AMap geocoding details, time-slot availability logic, venue-deal management, data quality validation rules, and assignment algorithm specifics — see [references/venue-ops.md](references/venue-ops.md).
