...
**Apply this skill by:**
1. Selecting the archetype mascot (Corgi — 社牛柯基 — for celebration)
...
Layout:
- Top half: A joyful corgi mascot (社牛柯基) in circular vignette, sitting with a small open gift box, tail wagging. Low-poly geometric illustration style with painterly textures.
...
**Apply this skill by:**
1. Selecting the Koala replacement — Bear (树洞考拉) for warm/empty feeling
...
Layout:
- Center: A calm bear mascot (树洞考拉) in circular vignette, holding a small empty calendar or tea cup. Low-poly geometric illustration with painterly textures.
