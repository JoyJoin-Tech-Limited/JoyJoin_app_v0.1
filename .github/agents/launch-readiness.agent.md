...
argument-hint: "Describe the launch scope, target environment, affected workflows, current concerns, and whether you need a blocker review, risk summary, or go-no-go checklist."
agents: []
---
...
5. Provide the smallest actionable next-step list to reach readiness.
