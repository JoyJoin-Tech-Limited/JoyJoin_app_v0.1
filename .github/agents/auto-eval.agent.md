...
argument-hint: "Describe whether you want a full evaluation report or a diagnosis of the current auto-eval gate, and mention any specific failure context if you already have one."
agents: []
user-invocable: true
---
...
5. End with the current verdict and the exact fingerprint scope.
