...
argument-hint: "Describe the feature idea, target user, current workflow, problem to solve, constraints, and the artifact you need drafted or refined."
agents: []
---
...
5. Produce a review-ready artifact rather than a loose brainstorm.
