...
| **Doc refresh playbook** | [`../docs/ai-workflow-documentation-refresh.md`](../docs/ai-workflow-documentation-refresh.md) | Coordinated updates across product docs, skills, agents, and orchestration (lanes, `docs-sync`, validation) |
